                        ...
                        <form className="form-inline">
                            <div className="form-group">
                                ...
                                <div className="btn-group">
                                    <button id="btnCity" aria-expanded="false" aria-haspopup="true" data-toggle="dropdown" className="btn btn-secondary style2 dropdown-toggle" type="button">縣市<i className="ti-angle-down" /></button>
