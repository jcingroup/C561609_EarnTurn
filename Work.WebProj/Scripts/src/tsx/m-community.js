    ...
    var GirdForm = (function (_super) {
        ...
        GirdForm.prototype.render = function () {
            ...
            if (this.state.edit_type == 0) {
                ...
                var outHtml = (React.createElement("div", null, React.createElement("ul", {"className": "breadcrumb"}, React.createElement("li", null, React.createElement("i", {"className": "fa-list-alt"}), this.props.menuName)), React.createElement("h4", {"className": "title"}, " ", this.props.caption, " 基本資料維護"), React.createElement("form", {"className": "form-horizontal", "onSubmit": this.handleSubmit}, React.createElement("div", {"className": "col-xs-10"}, React.createElement("div", {"className": "form-group"}, React.createElement("label", {"className": "col-xs-2 control-label"}, "標題"), React.createElement("div", {"className": "col-xs-8"}, React.createElement("input", {"type": "text", "className": "form-control", "onChange": this.changeFDValue.bind(this, 'community_name'), "value": field.community_name, "maxLength": 64, "required": true})), React.createElement("small", {"className": "col-xs-2 text-danger"}, "(必填) ")), React.createElement("div", {"className": "form-group"}, React.createElement("label", {"className": "col-xs-2 control-label"}, "登錄帳號"), React.createElement("div", {"className": "col-xs-8"}, React.createElement("input", {"type": "text", "className": "form-control", "onChange": this.changeFDValue.bind(this, 'account'), "value": field.account, "maxLength": 64, "required": true})), React.createElement("small", {"className": "col-xs-2 text-danger"}, "(必填) ")), React.createElement("div", {"className": "form-group"}, React.createElement("label", {"className": "col-xs-2 control-label"}, "登錄密碼"), React.createElement("div", {"className": "col-xs-8"}, React.createElement("input", {"type": "password", "className": "form-control", "onChange": this.changeFDValue.bind(this, 'passwd'), "value": field.passwd, "maxLength": 64, "required": true})), React.createElement("small", {"className": "col-xs-2 text-danger"}, "(必填) ")), React.createElement("div", {"className": "form-group"}, React.createElement("label", {"className": "col-xs-1 control-label"}, "內容"), React.createElement("div", {"className": "col-xs-8"}, React.createElement("textarea", {"type": "date", "className": "form-control", "id": "intro", "name": "intro", "value": field.intro, "onChange": this.changeFDValue.bind(this, 'intro')}))), React.createElement("div", {"className": "form-action"}, React.createElement("div", {"className": "col-xs-4 col-xs-offset-2"}, React.createElement("button", {"type": "submit", "className": "btn-primary"}, React.createElement("i", {"className": "fa-check"}), " 儲存"), React.createElement("button", {"type": "button", "onClick": this.noneType}, React.createElement("i", {"className": "fa-times"}), " 回前頁")))))));
            }
            return outHtml;
        };
